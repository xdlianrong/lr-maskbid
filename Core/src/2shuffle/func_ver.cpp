...
int func_ver::check_D_op(Mod_p c_D0, Mod_p c_z, vector<Mod_p>* c_A, vector<Mod_p>* c_B, vector<ZZ>* chal_1, ZZ chal_2, vector<ZZ>* A_bar, ZZ r_A_bar, long n) {
	...
	for (int i = 0; i < c_B->size(); i++)
		cout << c_B->at(i) << endl;
	cout << "chal_1: " << endl;
	for (int i = 0; i < chal_1->size(); i++)
		cout << chal_1->at(i) << endl;
	cout << "chal_2: " << chal_2 << endl;
	cout << "A_bar: " << endl;
	for (int i = 0; i < A_bar->size(); i++)
		cout << A_bar->at(i) << endl;
	cout << "r_A_bar: " << r_A_bar << endl;*/
...
int func_ver::check_Delta_op(Mod_p c_dh, Mod_p c_Delta, vector<ZZ>* chal, vector<ZZ>* Delta_bar, vector<ZZ>* d_bar, ZZ r_Delta_bar, ZZ chal_1, ZZ chal_2, ZZ chal_3) {
	...
	//cout << prod << " | " << (Delta_bar->at(n - 1) & d_bar->at(0)) << " | " << Delta_bar->at(0) << endl;
	//cout << (prod == Delta_bar->at(n - 1) & d_bar->at(0) == Delta_bar->at(0)) << endl;
	//cout << prod << " | " << Delta_bar->at(0) << endl;
